...
<html>
  <head>
    <title>TECHNOPAK TEMP HUMI by Rizwan </title>
    ...
    <style>
      ...
      .cards {max-width: 1200px; margin: 0 auto; display: grid; grid-gap: 2rem; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));}
  ...
  <body>
    <div class="topnav">
      <h3>TECHNOPAK TEMPERATURE HUMIDITY DATA LOGER dgpoult</h3>
    </div>
      ...
      <div class="cards">
        ...
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1rem;">Actual Temp & Humidity</h3>
          </div>
          <!-- <p class="humidityColor"><span> UPDATE_CONT= </span><span id="ESP32_01_cont"></span></p> -->
          <!-- Displays the humidity and temperature values received from ESP32. *** -->
          <h2 class="temperatureColor"><i class="fas fa-thermometer-half"></i> TEMPERATURE1</h2>
          <p class="temperatureColor"><span class="reading"><span id="ESP32_01_Temp"></span> &deg;C</span></p>
          <h1 class="humidityColor"><i class="fas fa-tint"></i> HUMIDITY1</h1>
        ...
        <div class="card">
          <div class="card header">
            <h3 style="font-size: 1rem;">Brooder and Outside Temprature </h3>
          </div>
          
          <!-- Displays the humidity and temperature values received from ESP32. *** -->
          <h2 class="temperatureColor"><i class="fas fa-thermometer-half"></i> TEMP2_Brooder</h2>
          <p class="temperatureColor"><span class="reading"><span id="ESP32_01_Temp2"></span> &deg;C</span></p>
          <h1 class="temperatureColor"><i class="fas fa-thermometer-half"></i> TEMP3_Outside</h1>
          <p class="temperatureColor"><span class="reading"><span id="ESP32_01_Humd2"></span> &percnt;</span></p>
          <!-- *********************************************************************** -->
    ...
    <script>
      ...
      document.getElementById("ESP32_01_cont").innerHTML = "NN";
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp32_01") {
              ...
              document.getElementById("ESP32_01_cont").innerHTML = myObj.cont;
