<?php
  ...
  if (!empty($_POST)) {
    ...
    $temp2_brooder = $_POST['temp2_brooder'];
    $temp3_outside = $_POST['temp3_outside'];
    ...
    $sql = "UPDATE esp32_table_dht11_leds_update SET temperature = ?, temp2_brooder = ?, temp3_outside = ?, humidity = ?, status_read_sensor_dht11 = ?,  time = ?, date = ? , fan1_on_temp = ?, fan1_off_temp = ?, fan1_on_time = ?, fan1_off_time = ?, fan2_on_temp = ?, fan2_off_temp = ?,fan2_on_time = ?, fan2_off_time = ?, fan3_on_temp = ?, fan3_off_temp = ?,fan3_on_time = ?, fan3_off_time = ?, fan4_on_temp = ?, fan4_off_temp = ?,fan4_on_time = ?, fan4_off_time = ?, fan5_on_temp = ?, fan5_off_temp = ?,fan5_on_time = ?, fan5_off_time = ?, fan6_on_temp = ?, fan6_off_temp = ?,fan6_on_time = ?, fan6_off_time = ?, fan7_on_temp = ?, fan7_off_temp = ?,fan7_on_time = ?, fan7_off_time = ?, fan8_on_temp = ?, fan8_off_temp = ?,fan8_on_time = ?, fan8_off_time = ?, fan9_on_temp = ?, fan9_off_temp = ?,fan9_on_time = ?, fan9_off_time = ?, fan10_on_temp = ?, fan10_off_temp = ?,fan10_on_time = ?, fan10_off_time = ?, fan11_on_temp = ?, fan11_off_temp = ?,fan11_on_time = ?, fan11_off_time = ?, fan12_on_temp = ?, fan12_off_temp = ?,fan12_on_time = ?, fan12_off_time = ?, pad1_on_temp = ?, pad1_off_temp = ?,pad1_on_time = ?, pad1_off_time = ?, pad2_on_temp = ?, pad2_off_temp = ?, pad2_on_time = ?, pad2_off_time = ?, heat_on_temp = ?, heat_off_temp = ?, device_id = ?, update_cont = ? WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($temperature,$temp2_brooder,$temp3_outside,$humidity,$status_read_sensor_dht11,$tm,$dt,$fan1_on_temp,$fan1_off_temp,$fan1_on_time,$fan1_off_time,$fan2_on_temp,$fan2_off_temp,$fan2_on_time,$fan2_off_time,$fan3_on_temp,$fan3_off_temp,$fan3_on_time,$fan3_off_time,$fan4_on_temp,$fan4_off_temp,$fan4_on_time,$fan4_off_time,$fan5_on_temp,$fan5_off_temp,$fan5_on_time,$fan5_off_time,$fan6_on_temp,$fan6_off_temp,$fan6_on_time,$fan6_off_time,$fan7_on_temp,$fan7_off_temp,$fan7_on_time,$fan7_off_time,$fan8_on_temp,$fan8_off_temp,$fan8_on_time,$fan8_off_time,$fan9_on_temp,$fan9_off_temp,$fan9_on_time,$fan9_off_time,$fan10_on_temp,$fan10_off_temp,$fan10_on_time,$fan10_off_time,$fan11_on_temp,$fan11_off_temp,$fan11_on_time,$fan11_off_time,$fan12_on_temp,$fan12_off_temp,$fan12_on_time,$fan12_off_time,$pad1_on_temp,$pad1_off_temp,$pad1_on_time,$pad1_off_time,$pad2_on_temp,$pad2_off_temp,$pad2_on_time,$pad2_off_time,$heat_on_temp,$heat_off_temp,$device_id,$update_cont,$id));
    Database::disconnect();
    //........................................ 
    ...
    // This table is also used to store and record the state of the LEDs, the state of the LEDs is controlled from the "home.php" page. 
    // This table is operated with the "INSERT" command, so this table will contain many rows.
		$sql = "INSERT INTO esp32_table_dht11_leds_record (id,board,temperature,humidity,status_read_sensor_dht11,LED_01,LED_02,time,date,fan1_on_temp) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($id_key,$board,$temperature,$humidity,$status_read_sensor_dht11,$led_01,$led_02,$tm,$dt,$fan1_on_temp));
    //::::::::
