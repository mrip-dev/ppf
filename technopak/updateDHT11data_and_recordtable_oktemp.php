<?php
  ...
  if (!empty($_POST)) {
    ...
    $sql = "UPDATE esp32_table_dht11_leds_update SET temperature = ?, humidity = ?, status_read_sensor_dht11 = ?, time = ?, date = ? , fan1_on_temp = ?, fan1_off_temp = ?, fan2_on_temp = ?, fan2_off_temp = ?, fan3_on_temp = ?, fan3_off_temp = ?, fan4_on_temp = ?, fan4_off_temp = ?, fan5_on_temp = ?, fan5_off_temp = ?, fan6_on_temp = ?, fan6_off_temp = ?, fan7_on_temp = ?, fan7_off_temp = ?, fan8_on_temp = ?, fan8_off_temp = ?, fan9_on_temp = ?, fan9_off_temp = ?, fan10_on_temp = ?, fan10_off_temp = ?, fan11_on_temp = ?, fan11_off_temp = ?, fan12_on_temp = ?, fan12_off_temp = ? WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($temperature,$humidity,$status_read_sensor_dht11,$tm,$dt,$fan1_on_temp,$fan1_off_temp,$fan2_on_temp,$fan2_off_temp,$fan3_on_temp,$fan3_off_temp,$fan4_on_temp,$fan4_off_temp,$fan5_on_temp,$fan5_off_temp,$fan6_on_temp,$fan6_off_temp,$fan7_on_temp,$fan7_off_temp,$fan8_on_temp,$fan8_off_temp,$fan9_on_temp,$fan9_off_temp,$fan10_on_temp,$fan10_off_temp,$fan11_on_temp,$fan11_off_temp,$fan12_on_temp,$fan12_off_temp,$id));
    Database::disconnect();
    //........................................ 
