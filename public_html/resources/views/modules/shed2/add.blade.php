                ...
                <div class="col-lg-12 col-12  layout-spacing">
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('shed2.store') }}" class="m-3 p-3" method="POST">
                                @csrf
                                   <div class="row">
                                    ...
                                    <div class="form-group col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" name="feed_recieved" id="name" value="{{ old('Water_intake') }}" placeholder="Enter Feed">
                                    </div>
                                    </div>
                                    <div class="form-group col-6 mb-2">
