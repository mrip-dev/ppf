            ...
            <div class="middle-content container-xxl p-0">
                 ...
                 <div class="page-meta">
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/shed2">Shed2R</a></li>
                ...
                <div class="col-lg-12 col-12  layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('shed2.update', $data->id) }}" class="m-3 p-3" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 mb-2">
                                        ...
                                        <input type="text" class="form-control" name="water_intake" id="name" value="{{ $data->water_intake }}" placeholder="Enter Water Intake(L)">
                                    </div>
                                    </div>
                                    <div class="row">
                                    <div class="form-group col-6 mb-2">
