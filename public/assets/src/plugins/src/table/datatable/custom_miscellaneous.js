$(document).ready(function() {
    ...
    */
    ...
    var pageValue = parseInt(pageParam, 10); 
    if (isNaN(pageValue)) {
        // Check if the conversion was successful (pageValue is a valid integer)
       pageValue=1;
    }
    table.page(pageValue - 1).draw(false); // Subtract 1 since DataTables uses 0-based indexing for pages
