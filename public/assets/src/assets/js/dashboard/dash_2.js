window.addEventListener("load", function(){
    ...
    if (ParsedObject.settings.layout.darkMode) {
      ...
      */
      var options = {
          ...
          series: studentsAttendencevals,
          labels: studentsAttendence,
      ...
      var optionsEm = {
        ...
        colors: ['#622bd7', '#e2a03f', '#e7515a', '#e2a03f','red','blue','yellow'],
        dataLabels: {
          enabled: true
        },
        legend: {
        ...
        series: employeesAttendencevals,
        labels: employeesAttendence,
  ...
  */
  ...
  var chartEm = new ApexCharts(
    document.querySelector("#chart-em"),
    optionsEm
 );
