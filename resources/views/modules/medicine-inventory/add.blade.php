                ...
                <div class="col-lg-12 col-12  layout-spacing">
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <form action="{{ route('medicine-inventory.store') }}" class="m-3 p-3" method="POST">
                                @csrf
                                   <div class="row">
                                   ...
                                   <div class="form-group col-6 mb-2">
                                    ...
                                    <div class="form-group col-6 mb-2">
                                        ...
                                        <input type="hidden" class="form-control" name="farm_id" id="name" value="1">
                                        <input type="hidden" class="form-control" name="session_id" id="name" value="1">
                                    </div>
                                    <div class="form-group col-6 mb-2"  id="recieved_amount">
                                        <label for="name">Amount</label>
                                        <input type="text"  class="form-control" name="amount" id="name" value="{{ old('amount') }}" placeholder="Enter Amount">
                                    </div>
                                    </div>
