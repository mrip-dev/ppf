...
<div class="layout-px-spacing">
	<div class="middle-content container-xxl p-0">
        ...
        @foreach($data as $datas)
                <tr>
<?php $usedfeed=App\Http\Controllers\Controller::getFeedUsedByAge($datas->day);
 $rem_b=$usedfeed['b']-$usedfeed['m']?>
        ...
        <td>{{$datas->day}}</td>
        <td>{{$datas->feed}}</td>
        <td><?Php $cf=$usedfeed['f']*50000/$rem_b; echo number_format($cf,2);  ?></td>
        <td><?Php echo number_format($datas->feed-$cf,2);  ?></td>
