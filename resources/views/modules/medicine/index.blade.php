...
<div class="layout-px-spacing">
	<div class="middle-content container-xxl p-0">
        ...
        @endif
            ...
            <div class="row">
                    <div class="col text-end">
                        <a href="/medicine/create" class="btn btn-primary">Add New</a>
                    </div>
                </div>
        ...
        <td>
                        <div class="row">
                            <div class="col">
                            <a href="{{ route('medicine.edit', $datas->id) }}" class="btn btn-primary">Edit</a>
                            </div>
                            <div class="col">
                            <form action="{{ route('medicine.destroy', $datas->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
