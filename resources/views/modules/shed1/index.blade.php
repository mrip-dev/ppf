...
<div class="layout-px-spacing">
	<div class="middle-content container-xxl p-0">
         ...
         <div class="page-meta">
                                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Shed1L</li>
                                    </ol>
                                </nav>
                            </div>
                            <!-- /BREADCRUMB -->
        ...
        @endif
            ...
            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h2 class="m-3">Shed1L Entries</h2>
                                </div>
                            </div>
            <div class="row">
                    <div class="col text-end">
                        <a href="/shed1/create" class="btn btn-primary">Add New</a>
                    </div>
                </div>
        ...
        <td>
                        <div class="row">
                            <div class="col">
                            <a href="{{ route('shed1.edit', $datas->id) }}" class="btn btn-primary">Edit</a>
                            </div>
                            <div class="col">
                            <form action="{{ route('shed1.destroy', $datas->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
